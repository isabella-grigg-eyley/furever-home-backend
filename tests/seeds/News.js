      ...
      return knex("News").insert([
        {
          id: 1,
          organisation: "SPCA",
          headline: "Grumpy Cat would like to be known as Crabby Cat ",
          content:
            "After many years in the spotlight, Crabby Cat would really love to lead a quiet life and has changed his name by statutory declaration to now be Crabby Cat.",
          image: "/images/news/grumpycat.jpg"
        },
        {
          id: 2,
        ...
        },
        {
          ...
          image: "/images/news/faircow.jpg"
        },
        {
          id: 5,
          organisation: "SeaWorld",
          headline: "SeaWorld and ex-boss to pay $5m to settle fraud claim",
          content:
          ...
          image: "/images/news/seaworld.jpg"
        }
      ]);
    });
};
